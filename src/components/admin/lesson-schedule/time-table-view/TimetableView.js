...
const TimetableView = () => {
  ...
  const getScheduleColor = (identifier) => {
    // List of pleasant colors that work well with white text
    const colors = [
      "#ff4d4f", // Red (original)
      "#1890ff", // Blue
      "#52c41a", // Green
  ...
  return (
    <div style={{ padding: 0 }}>
      ...
      <CreateLessonScheduleModal
        ...
        schedule={newScheduleData} // You may need to add this prop to your CreateLessonScheduleModal
      />
